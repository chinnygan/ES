 ...
 * CSCI E-92 Fall 2015, Professor James L. Frankel, Harvard Extension School
 *
...
void uartInit(UART_MemMapPtr uartChannel, int clockInKHz, int baud) {
    ...
    if(uartChannel == UART0_BASE_PTR) {
    	...
    	/* See 10.3.1 on page 275 of the K70 Sub-Family Reference Manual,
    	 * Rev. 2, Dec 2011 for K70 Signal Multiplexing and Pin Assignments.
    	 *
    	 * See 11.4.1 on page 309 of the K70 Sub-Family Reference Manual,
    	 * Rev. 2, Dec 2011 for Pin Control Register n (PORTx_PCRn).
    	 *
    	 * Use the appropriate Pin Control Register (PORTx_PCRn) to set the
    	 * pin MUX control field to choose the configuration of that pin. */
